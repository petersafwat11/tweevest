            ...
            <Carousel afterChange={onChange} autoplay>
                <div>
                    <div className="Slide-box-otr">
                        <div className="Slide-box-inr bg-white px-[32px] pt-[32px] pb-[40px]">
                            ...
                            <div className="performance-otr py-[40px] border-b-[1px] border-b-border">
                                ...
                                <div className="performance-box-otr flex flex-wrap gap-[12px]">
                                    <div className="performance-box bg-greenlight p-[8px] rounded-8 w-[30.5%]">
                                    ...
                                    <div className="performance-box bg-redlight p-[8px] rounded-8 w-[30.5%]">
