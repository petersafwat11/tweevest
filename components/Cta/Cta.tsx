    ...
    return (
        ...
        >
            ...
            <div className="bg-shapes-otr flex justify-between absolute left-[0px] top-[0px] w-[100%] h-[100%]">
                <Image className="cta-shape1 object-contain" width="230px" height="220px" src="/svg/cta-bg-shape1.svg" alt="Shape" />
                <Image className="cta-shape2 object-contain" width="230px" height="220px" src="/svg/cta-bg-shape2.svg" alt="Shape" />
            </div>
        </div>
    )
}