                ...
                <ul className="social-ul flex items-center gap-[16px]">
                    <li className="social-li">
                        <a href="" className="flex items-center justify-center social-a w-[24px] h-[24px] rounded-[100%] bg-[#334883] hover:bg-primary">
                            <img className="object-contain object-left" width="14px" height="14px" src="/svg/instagram-icon.svg" alt="logo" />
                        </a>
                    </li>
                    <li className="social-li">
                        <a href="" className="flex items-center justify-center social-a w-[24px] h-[24px] rounded-[100%] bg-[#334883] hover:bg-primary">
                            <img className="object-contain object-left" width="14px" height="14px" src="/svg/dribble-icon.svg" alt="logo" />
                        </a>
                    </li>
                    <li className="social-li">
                        <a href="" className="flex items-center justify-center social-a w-[24px] h-[24px] rounded-[100%] bg-[#334883] hover:bg-primary">
                            <img className="object-contain object-left" width="14px" height="14px" src="/svg/twitter-icon.svg" alt="logo" />
                        </a>
                    </li>
                    <li className="social-li">
                        <a href="" className="flex items-center justify-center social-a w-[24px] h-[24px] rounded-[100%] bg-[#334883] hover:bg-primary">
                            <img className="object-contain object-left" width="14px" height="14px" src="/svg/youtube-icon.svg" alt="logo" />
                        </a>
                    </li>
                </ul>
            </div>
