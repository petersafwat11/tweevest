                    ...
                    <table className="table-main w-[100%] mb-[32px] mt-[24px]">
                        <thead>
                            <th scope="col" className="w-[90px]">
                                <div className="head-text-otr pr-[8px] py-[5px]">
                                    <p className="heading-XSB head-text text-primary-dark text-left" title="Symbol">
                                        Symbol
                                    </p>
                                </div>
                            </th>
                            <th scope="col">
                                <div className="head-text-otr pr-[8px] py-[5px]">
                                    <p className="heading-XSB head-text text-primary-dark text-left" title="Company">
                                        Company
                                    </p>
                                </div>
                            </th>
                            <th scope="col" className="w-[50px]">
                                <div className="head-text-otr pr-[8px] py-[5px]">
                                    <p className="heading-XSB head-text text-primary-dark text-left" title="RS">
                                        RS
                                    </p>
                                </div>
                            </th>
                            <th scope="col" className="w-[90px]">
                                <div className="head-text-otr pr-[8px] py-[5px]">
                                    <p className="heading-XSB head-text text-primary-dark text-center" title="5-Day Perf.">
                                        5-Day Perf.
                                    </p>
                                </div>
                            </th>
                        ...
                        <tbody>
                            <tr>
                                <td scope="col">
                                    <div className="body-text-otr pr-[8px] py-[10px] body-text-otr1">
                                        <p className="heading-XS text-primary-dark2 body-text text-left" title="AMZN">
                                            AMZN
                                        </p>
                                    </div>
                                </td>
                                <td scope="col">
                                    <div className="body-text-otr pr-[8px] py-[10px] body-text-otr1">
                                        <p className="heading-XS text-primary-dark2 body-text text-left" title="Amazon">
                                            Amazon
                                        </p>
                                    </div>
                                </td>
                                <td scope="col">
                                    <div className="body-text-otr pr-[8px] py-[10px] body-text-otr1">
                                        <p className="heading-XS text-primary-dark2 body-text text-left" title="78">
                                            78
                                        </p>
                                    </div>
                                </td>
                                <td scope="col">
                                    <div className="body-text-otr pr-[8px] py-[10px] body-text-otr1">
                                        <p className="heading-XS text-primary-dark2 body-text text-center" title="+15%">
                                            +15%
                                        </p>
                                    </div>
                                </td>
                            ...
                            <tr className="bg-[#F8F8F8]">
                                ...
                                <td scope="col">
                                    <div className="body-text-otr pr-[8px] py-[10px] body-text-otr1">
                                        <p className="heading-XS text-primary-dark2 body-text text-left" title="60">
                                            60
                                        </p>
                                    </div>
                                </td>
                            ...
                            <tr className="bg-[#F8F8F8]">
                                ...
                                <td scope="col">
                                    <div className="body-text-otr pr-[8px] py-[10px] body-text-otr1">
                                        <p className="heading-XS text-primary-dark2 body-text text-left" title="55">
                                            55
                                        </p>
                                    </div>
                                </td>
